...
app.controller("myController", function ($scope) {
    ...
    $scope.luuSuaLop = function (lopThuoc, tenLopLopThuoc) {
        $scope.tabSuaLop = true;
        $scope.tabLop = false;
        
        var index = $scope.danhSachTimKiemLop.indexOf(lopThuoc) ;
        
        //TODO cap nhat lop muon sua tai option tim kiem 
        $scope.danhSachTimKiemLop[index] = tenLopLopThuoc;
        $scope.danhSachTimKiemLop.splice(index, 1);
        $scope.danhSachTimKiemLop.push(tenLopLopThuoc);

        //TODO cap nhat lop muon sua tai option them, sua hoc sinh
        $scope.danhSachChonThemSua[index] = tenLopLopThuoc;
        $scope.danhSachChonThemSua.splice(index, 1);
        $scope.danhSachChonThemSua.push(tenLopLopThuoc);
    };
});
